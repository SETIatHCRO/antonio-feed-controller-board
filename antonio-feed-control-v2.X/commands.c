...
/*32*/    {"accelonesec", accelonesec_command, "accel1s.txt"},
/*33*/    {"aa", accelonesec_command, "accel1s.txt"},
/*34*/    {"osc", setosctun_command, NULL},
/*35*/    {"rs", rs232_test_command, NULL},
/*36*/    {"restart", restart_command, "restart.txt"},
/*37*/    {"shutdown", shutdown_command, "shutdown.txt"},
/*38*/    {"autostart", autostart_command, "autostrt.txt"},
/*39*/    {"getswitchtemp", getswitchtemp_command, "getstemp.txt"},
/*40*/    {"setswitchtemp", setswitchtemp_command, "setstemp.txt"},
/*41*/    {"getstate", autostartgetstate_command, "getstate.txt"},
/*42*/    {"state", autostartgetstate_command, "getstate.txt"},
/*43*/    {"getbackingtime", autostartgetbackingtime_command, "getvcbkt.txt"},
/*44*/    {"setbackingtime", autostartsetbackingtime_command, "setvcbkt.txt"},
/*45*/    {"getstandbytime", autostartgetstandbytime_command, "getvcsbt.txt"},
/*46*/    {"setstandbytime", autostartsetstandbytime_command, "setvcsbt.txt"},
