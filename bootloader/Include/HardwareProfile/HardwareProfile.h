...
#define GetPeripheralClock()	(GetSystemClock()/4)	// Divisor is dependent on the value of FPBDIV set(configuration bits).
...
#elif defined(PROTO_BOARD_UBW32)
        #include "HardwareProfile_UBW32.h"
#else 
